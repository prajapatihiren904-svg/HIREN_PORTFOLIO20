...
function renderQRSection() {
  ...
  // Auto-detect GitHub Pages / Vercel Web URL when hosted online, or fallback to live portfolio URL
  const isWebHosted = window.location.protocol.startsWith('http');
  const targetUrl = isWebHosted ? window.location.href : (PORTFOLIO_DATA.PORTFOLIO_URL || "https://prajapatihiren904-svg.github.io/hiren-portfolio2/");
